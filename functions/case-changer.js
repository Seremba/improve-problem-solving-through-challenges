/* Write a function `caseChange` that accepts a string and a boolean as
arguments. The function should return the uppercase version of the string
 if the boolean is true. The function should return the
