/*
 Write a function `lengthiestWord` that accepts a sentence string as
 an argument. The function should
 return the longest word of the sentence. If there is a tie,
 return the word that appears later
 in the sentence.
*/
